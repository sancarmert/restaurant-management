...
func GetOrderItemsByOrder() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"errror": "error occured while listing order items by order ID"})
			return
		}
...
func ItemsByOrder(id string) (OrderItems []primitive.M, err error) {
	...
	lookupTableStage := bson.D{{"$lookup", bson.D{{"from", "table"}, {"localfield", "order.table_id"}, {"foreignFieldId", "table_id"}, {"as", "table"}}}}
